...
import processBimImage from "@/assets/process-bim-coordination.png";
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <img 
                src={processBimImage} 
                alt="BIM coordination - MEP systems and infrastructure modeling" 
                className="w-full h-auto rounded-2xl object-cover aspect-[4/3] shadow-lg" 
              />
            </div>
          </div>
        </div>
